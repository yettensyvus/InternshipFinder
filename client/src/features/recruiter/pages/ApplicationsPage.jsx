...
export default function Applications() {
  ...
  return (
    <RecruiterPageLayout
      title={t('recruiterApplications.title')}
      subtitle={t('recruiterApplications.subtitle')}
      headerClassName="bg-gradient-to-r from-violet-600 via-indigo-600 to-blue-600"
