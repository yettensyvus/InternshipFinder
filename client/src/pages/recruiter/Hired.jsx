  ...
  const ResumePanel = ({ resumeUrl }) => {
    ...
    return (
      <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 overflow-hidden h-full flex flex-col">
        <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-emerald-600 to-green-600 flex-shrink-0">
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 pt-12 pb-20">
      <div className="w-full px-2 md:px-6">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
          <div>
            <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 dark:from-emerald-400 dark:via-green-400 dark:to-teal-400 pb-2">
        ...
        <div className="bg-white/70 dark:bg-gray-800/60 border border-gray-200/60 dark:border-gray-700/60 rounded-3xl shadow-xl overflow-hidden">
          ...
          <div className="p-6">
            {loading ? (
              ...
              <div className="text-gray-600 dark:text-gray-300">{t('recruiterHired.noHired')}</div>
            ) : (
                  ...
                  <div className="bg-white dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm h-full overflow-y-auto">
                    {!selectedApp ? (
                      ...
                      <div className="space-y-6">
                        <div>
                          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-[10px] font-bold uppercase tracking-wider mb-3">
                            <CheckBadgeIcon className="h-3.5 w-3.5" />
                            {t('recruiterHired.statusHired')}
                          </div>
                        ...
                        <div className="pt-6 border-t border-gray-100 dark:border-gray-800">
                           <div className="p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-900/30">
                              <div className="flex items-center gap-3 text-emerald-700 dark:text-emerald-400">
                                 ...
                                 <div>
                                    <div className="text-sm font-bold">{t('recruiterHired.officialJoin')}</div>
                                    <div className="text-xs opacity-80">{t('recruiterHired.officialJoinHint')}</div>
                                 </div>
                              </div>
                           </div>
                        </div>
